<?php
    ...
    if (isset($_POST['submit']))  {
        ...
        if($conn->connect_error){
            ...
            $stmt = $conn -> prepare("SELECT * FROM `Recruiter` WHERE `email`=? AND `password`=?");
        ...
        <div style="display:none;" id="myDiv" class="animate-bottom">
            ...
            <div class="container">
                <form id="form" class="form" method="POST" >
                    ...
                    <p>Forgot your password, Click <a style="color: blue;text-decoration: none;" href="./forgetpassword/forgot-password.php"> here</a> to reset</p>
